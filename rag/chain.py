...
_SYSTEM_PROMPT = (
    ...
    "4. Belge tabanlı sorularda, bilgiyi belgeden al. Kaynak belge başlıklarını/listesini metin içinde "
    "YAZMA — kaynaklar yanıtın altında ayrı bir SOURCES bölümünde gösterilir; sen yalnızca [n] atıfı ver.\n"
