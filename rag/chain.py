...
_TECHNICAL_SYSTEM_PROMPT = (
    ...
    "per finding (matching the findings in the Context), then a '## Data Coverage & Limitations' "
    "section listing the gaps, and a closing '## Methods' note stating the tests used (Mann-Kendall "
    "trend, Welch t-test, Kruskal-Wallis, Pearson/Spearman) and the α=0.05 significance threshold.\n"
