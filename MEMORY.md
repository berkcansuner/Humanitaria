...
1. **Karar verildi, sıradaki oturumda BİRLİKTE planlanacak (2026-07-10, 4. iş):** admin kullanıcı yönetimi + ayarlar/profil sayfası + arayüz dil seçici (TR/EN) — kullanıcı bu üçünü ayrı ayrı değil tek turda brainstorm→plan etmek istedi.
