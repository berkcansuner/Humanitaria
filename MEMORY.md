...
1. **▶ ÖNCE: `feat/admin-users-settings` merge kararı** (üstteki 2026-07-11 bloğu — branch hazır, review temiz, kullanıcı onayı bekliyor). **SONRA sıradaki büyük aday: arayüz dil seçici (TR/EN)** — üçlünün (a admin listesi + b ayarlar ✅ 2026-07-11'de bitti) kalan son parçası; EN BÜYÜK/EN RİSKLİ: Landing/Auth/Chat/Reports/Admin/Settings'in hepsinde sabit İngilizce metin var (i18n kütüphanesi yok), tam tarama+entegrasyon gerektirir — kendi brainstorm→plan turunu ister.
