...
2. **Kullanıcıya görünür adaylar (2026-07-10'da sunuldu, hâlâ seçilmedi):** (a) **sohbet export/paylaş** — PDF/MD indirme + salt-okunur link (rapor xhtml2pdf altyapısı yeniden kullanılır) / (b) **RAG kalite cilası** — akıllı "belge bulunamadı" önerileri + "güncel/latest" tazelik hedeflemesi / (c) **M&E Reports geliştirme** — kullanıcı ilgi belirtti ama kapsam netleşmedi (yeni rapor türü mü, görselleştirme mi, zamanlanmış rapor mu, karşılaştırma mı — önce bunu netleştir).
