...
1. **Faz 5 — eski `default` namespace (31.628 vektör) silme:** v3 cutover canlı ve doğrulanmış; kullanıcıdan açık onay alınca sil (`delete_all`, namespace=''). Silinene dek rollback güvencesi olarak durur (index ~%55/2GB, acele yok).
